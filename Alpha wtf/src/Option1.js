class option1 extends Phaser.Scene {
    ...
    create(){
        ...
        this.OptionExit = this.add.text(width * 0.42, height * 0.38, 'Quitter', {
            color: '#000000',
        ...
        this.AZERTY = this.add.text(width * 0.42, height * 0.45, 'AZERTY', {
            color: '#000000',
            fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif',
            fontSize: 20
        })
        ...
        this.QWERTY = this.add.text(width * 0.42, height * 0.5, 'QWERTY', {
            color: '#000000',
            fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif',
            fontSize: 20
        })
        ...
        this.English = this.add.text(width * 0.55, height * 0.5, 'Anglais', {
            color: '#000000',
            fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif',
            fontSize: 20
        })
        ...
        this.French = this.add.text(width * 0.55, height * 0.45, 'Français', {
            color: '#000000',
            fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif',
            fontSize: 20
        })
